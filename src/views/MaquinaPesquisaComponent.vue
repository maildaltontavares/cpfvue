<template>
   ...
   <div class="flex-container ">  
         ...
         <div class=" text-start flex-element"> 
             ...
             <input type="text" id= "PesqMaquina"   @keypress.enter="apiPesquisaCRUDByFilial('maquina','nome',nomePesquisa)" ref="nomePesquisa" class="form-control form-control-sm campoPesquisaMinWidth  text-uppercase" v-model="nomePesquisa" placeholder="Informe a descricao da maquina" >
             <button type="button" class="btn btn-primary"    @click="apiPesquisaCRUDByFilial('maquina','nome',nomePesquisa)"><i class="bi bi-search input-group-append"></i></button>                
       ...
       <thead class="cabecalho " style="background-color:#003366;color: white;">
           <tr>
             <th class="col-1">COD</th>
               ...
               <th class="col-4 text-start">LOCAL</th>
            ...
            <template v-if="apiDisplayedDadosCRUD">
             ...
             <tr v-for="(i,indice) in apiDisplayedDadosCRUD" :key="indice">  
               ...
               <td class="col-2 text-start">
                ...
                <th class="col-1">
                  <router-link :to="{ name: 'maquina' , params: { codigo : i.codigo,operacao:'A'}}">                                        
                      <img src="@/assets/icon_editar.gif" alt="Editar" class="botao EspacoEntreBotoes" height="30">
                   </router-link>  

                  <!--
                  <router-link :to="{ name: 'maquina' , params: { codigo : i.codigo,operacao:'E'}}">                                        
 ...
 export default {
   ...
   methods: {
     ...
     NavegarParaInclusao( ){ 
       this.$router.push({name:'maquina' , params : { codigo: ' ' , operacao : 'I'}} ) 
     },
