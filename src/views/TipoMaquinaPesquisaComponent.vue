<template>
    ...
    <div class="flex-container ">  
          ...
          <div class=" text-start flex-element"> 
              ...
              <input type="text" id= "PesqTipoMaterial"   @keypress.enter="apiPesquisaCRUDByFilial('tipomaquina','nome',nomePesquisa)" ref="nomePesquisa" class="form-control form-control-sm campoPesquisaMinWidth  text-uppercase" v-model="nomePesquisa" placeholder="Informe o tipo de maquina" >
              <button type="button" class="btn btn-primary"    @click="apiPesquisaCRUDByFilial('tipomaquina','nome',nomePesquisa)"><i class="bi bi-search input-group-append"></i></button>                
        ...
        <thead class="cabecalho " style="background-color:#003366;color: white;">
            <tr>
              <th class="col-1">COD</th>
                <th class="col-4 text-start">DESCRIÇÃO</th>
                <th class="col-4 text-start">CLASSE MATERIAL</th>              
        ...
        <tbody>
             <template v-if="apiDisplayedDadosCRUD">
              ...
              <tr v-for="(i,indice) in apiDisplayedDadosCRUD" :key="indice">  
                ...
                <td class="col-2 text-start">
                     {{ i.classeMaterial.nome }}
                </td>                

             
                 <th class="col-1">
                   <router-link :to="{ name: 'tipomaquina' , params: { codigo : i.codigo,operacao:'A'}}">                                        
                       <img src="@/assets/icon_editar.gif" alt="Editar" class="botao EspacoEntreBotoes" height="30">
                    </router-link>  

                   <!--
                   <router-link :to="{ name: 'tipomaquina' , params: { codigo : i.codigo,operacao:'E'}}">                                        
  ...
  export default {
    name: 'TipoMaquinaPesquisaComponent',
    mixins: [ApiMixin],
    data: () => ({
      resultPesquisaCRUD : []  
    ...
    methods: {
      ...
      NavegarParaInclusao( ){ 
        this.$router.push({name:'tipomaquina' , params : { codigo: ' ' , operacao : 'I'}} ) 
      },
      setaPesquisaCRUD(pCursor) {  
        ...
        async created(){     
            ...
            let url = `${process.env.VUE_APP_BASE_URL}/tipomaquina/filial/00`;
