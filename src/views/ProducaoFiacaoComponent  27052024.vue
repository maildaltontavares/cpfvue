...
-->
    ...
    <PesquisaItemClasse @setaPesquisa="setaPesquisa($event)"   :tipoMaquinaProps="this.cdTipoMaquina"></PesquisaItemClasse>
...
<script> 
   ...
   import PesquisaOperador from '@/requires/PesquisaOperador';
    ...
    export default {
        ...
        mixins: [ApiMixin], 
        components: {  PesquisaOperador,   PesquisaItemClasse,Popper, money3: Money3Component,SimNao  },
        ...
        validations: {
            ...
            producaoFiacao: {  
                    ...
                    alfaTorcao: { required: helpers.withMessage('Informe o alfaTorcao de torção',  
                                ...
                                function(val) {
                                            ...
                                            { 
                                                    if(this.cdTipoMaquina=='05' || this.cdTipoMaquina=='04' ){
                                                        if(val==0){
                                                            return false
                                                        }else{
                                                            return true
        ...
        methods:{ 
            ...
            validaChave(){ 
               ...
               //console.log(chaveCompleta)     
                ...
                if (!(this.producaoFiacao.item==null || this.producaoFiacao.item=='') && chaveCompleta){ 
                    if(!(this.tipoMaquinaItem==null || this.tipoMaquinaItem=='')){
                        
                        if(this.tipoMaquinaItem != this.cdTipoMaquina){
                            chaveCompleta = false;
