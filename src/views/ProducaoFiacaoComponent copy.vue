    ...
    <form  @submit.stop.prevent="submitForm"  >  
        ...
        <div>  
            <div class="principal cinzaClaro">
                <p class="card-header text-center" style="font-size: 30px; margin-bottom: 80px; margin-top: 2%;color: blue; font-weight: bold;"> Produção Fiação {{ this.nmTpMaq }}</p>
            </div>    
        </div> 
                        ...
                        <div class="row espacoEntreComponentes  "  style="width:130px;"   > 
                            ...
                            <Popper arrow hover class="dark  "  style="margin-bottom:12px;  height:37px;"  >
                                ...
                                <input type="text"
                                    ...
                                    ref="localFisico" 
                                    @blur="buscaByChave" 
                                    @keyup="apiAddLeadingZero($event,producaoFiacao.localFisico)"
                                                    ...
                                                    <div class="frontCampoConjugado"> 
                                                        ...
                                                        <Popper arrow hover class="dark  ">
                                                                ...
                                                                <input type="text" 
                                                                    ...
                                                                    class="form-control form-control-sm text-center"
                                                                    maxlength="7"
                                                                    @keyup="apiAddLeadingZero($event,producaoFiacao.Item)"
                                                                    v-maska  data-maska="#######"
                                                                    :disabled="itemDesabilitado"
                                                                    :class="{ error: v$.producaoFiacao.item.$error}" v-model.lazy="v$.producaoFiacao.item.$model" 
                                                                    @blur="apiPesquisaParam('item', producaoFiacao.item, this.producaoFiacao)"> 
                    ...
                    <div  class="div-box ">
                      ...
                      <div class="flex-linha"> 
                        ...
                        <div class="row espacoEntreComponentes  "  style="width:130px;"   > 
                                    ...
                                    <label for="qtdeProduzida" class="col-form-label label_cabecalho">Qtde. Produz.</label> 
                        ...
                        <div class="row espacoEntreComponentes  "  style="width:130px;"   > 
                                    ...
                                    <label for="eficiencia" class="col-form-label label_cabecalho">Efic. Máquina</label> 
                        ...
                        <div class="row espacoEntreComponentes  "  style="width:130px;"   > 
                                    ...
                                    <label v-if="!(this.cdTipoMaquina =='02')"  for="rpm" class="col-form-label label_cabecalho">RPM</label> 
                                    <label v-if="(this.cdTipoMaquina =='02')"  for="rpm" class="col-form-label label_cabecalho">M/Min</label> 
                        ...
                        <div v-if="(this.exibeAlfaTorcao)" class="row espacoEntreComponentes  "  style="width:130px;"   > 
                                    ...
                                    <label for="alfaTorcao" class="col-form-label label_cabecalho">Alfa de Torção</label> 
                                                    ...
                                                    <div class="frontCampoConjugado"> 
                                                        ...
                                                        <Popper arrow hover class="dark  ">
                                                                ...
                                                                <input type="text" 
                                                                    ...
                                                                    class="form-control form-control-sm text-center"
                                                                    maxlength="5"
                                                                    @keyup="apiAddLeadingZero($event,producaoFiacao.operador)"
                                                                    v-maska  data-maska="#####"
                                                                    :class="{ error: v$.producaoFiacao.operador.$error}" v-model.lazy="v$.producaoFiacao.operador.$model" 
                        ...
                        <div class="row espacoEntreComponentes  "  style="width:130px;"   > 
                                    ...
                                    <Popper arrow hover class="dark  "  style="margin-bottom:12px;  height:37px;"  >  
                                        ...
                                        <input type="text"
                                            ...
                                            style="margin:0px;"
                                            maxlength="10"                                        
                                            @keyup="apiAddLeadingZero($event,producaoFiacao.loteProducao)"
                                            @blur="apiLoteFiacao()"
                                            ref="loteProducao"   
...
<!--
                        <div class="row espacoEntreComponentes " style="width:380px;"  > 
                            ...
                            <Popper arrow hover class="dark  " style="margin-bottom:12px;  height:37px;"  >
                                ...
                                <template #content v-if="v$.producaoFiacao.obs.$error">
                                    <div v-html="apiListaErros(v$.producaoFiacao.obs.$errors)"></div>
                                </template> 
                                ...
                                <input type="text"
                                    ...
                                    maxlength="30"                                        
                                    ref="obs" 
                                    :class="{ error: v$.producaoFiacao.obs.$error}" v-model.trim="v$.producaoFiacao.obs.$model"
                                > 
...
<!--
                    ...
                    <div>  
                        <div class="principal cinzaClaro">
                            <p class="card-header text-center" style="font-size: 12px; margin-bottom: 5px; margin-top: 2%;color: blue; font-weight: bold;">CORTES POR 1000 RH</p>
                        </div>    
                    </div> 
...
-->
                   ...
                   <!--
                    <div v-if="(this.cdTipoMaquina== '04' || this.cdTipoMaquina== '06' )" >                    
                         <div class="linha"></div>
                    </div>  
                    ...
                    <div v-if="(this.cdTipoMaquina== '04' || this.cdTipoMaquina== '06' )"  class="flex-linha">
                        ...
                        <div v-if="(this.exibeTensaoBobina )" class="row espacoEntreComponentes  "  style="width:130px;"   > 
                                    ...
                                    <label for="tensaoBobina" class="col-form-label label_cabecalho">Tensão bobina</label> 
                        ...
                        <div v-if="(this.exibeRpmCAR)" class="row espacoEntreComponentes  "  style="width:130px;"   > 
                                    ...
                                    <label for="rpmCAR" class="col-form-label label_cabecalho">RPM cardinha</label> 
                    ...
                    <div  v-if="(this.cdTipoMaquina== '04' || this.cdTipoMaquina== '06' )" class="flex-linha">     
                        ...
                        <div v-if="(this.exibeProb1)" class="row espacoEntreComponentes  "  style="width:130px;"   > 
                                    ...
                                    <Popper arrow hover class="dark  "  style="margin-bottom:12px;  height:37px;"  >  
                                        ...
                                        <money3 class="form-control text-end form-control-sm" maxlength="4"
        ...
        <div class="row rodape">
            ...
            <div class="col-3 div_rodape d-flex justify-content-end">
                    <button  v-if="tipoOperacao == 'I' || tipoOperacao == 'A'" type="button"  class="btn btn-sm btn-primary ms-2 me" accesskey="n" @click="exibeModal('cancelaEdicao','Deseja sair da edição?',['S','N'],'sucesso' )"><u>N</u>ovo</button> 

                    <button v-if="tipoOperacao == 'E'" type="button"  accesskey="e" class="btn btn-sm btn-danger ms-2 me"  @click="exibeModal('excluir','Confirma exclusão ?',['S','N'],'sucesso'  )"><u>E</u>xcluir
                    </button>              
...
<script> 
   ...
   import { required ,between} from '@vuelidate/validators'   ; //, minLength,maxLength
    ...
    export default {
        ...
        validations: {
            ...
            producaoFiacao: {  
                    ...
                    item: { required: helpers.withMessage('Informe o item produzido', required)} ,   
                    ...
                    //numeroRupturas: { required: helpers.withMessage('Informe o número de rupturas', required)} , 
                    ...
                    operador: { required: helpers.withMessage('Informe o operador da maquina', required)} , 	
                    ...
                    tensaoBobina: { between:  helpers.withMessage('Informe o valor entre 0.001 e 3', between(0.000, 3000) ) }, 
        ...
        methods:{ 
            setaPesquisa(e) { 
                ...
                //console.log(e.tipo )
                //console.log(e.obj.codigo)
                //console.log(e.obj.nome)
                ...
                //console.log(this.producaoFiacao.operador)
                //console.log(this.producaoFiacao.dsOperador)
            ...
            validaChave(){ 
                ...
                //console.log('ValidaChave 001');

                //console.log(chaveCompleta) 
 
                if ((this.cdTipoMaquina==null || this.cdTipoMaquina =='') && chaveCompleta){

                    this.mensagemErro = "Informe um tipo de máquina valido."; 
                    this.haErros = true ;
                    chaveCompleta = false;
                ...
                ///console.log('this.producaoFiacao.dataProducao nulo');
                    this.mensagemErro = ""; 
                    this.haErros = false ;
                ...
                if ((this.producaoFiacao.lado==null   ||  this.producaoFiacao.lado=='') && chaveCompleta){
                   //console.log('this.producaoFiacao.lado  nao nulo >> ' + this.producaoFiacao.lado);
                //} else{
                 //console.log('this.producaoFiacao.lado nulo');
                    chaveCompleta = false;
                }       
...
/*
                ...
                // Obtém a data informada pelo usuário (supondo que esteja em formato "YYYY-MM-DD")
                //let dataInformada = new Date("2023-06-07");

                let retorno = true;

                // Verifica se a data informada é maior que a data atual
                if(this.producaoFiacao.dataProducao==null || this.producaoFiacao.dataProducao=='') {
                    retorno = false;
                }else{
                    if (pData > dataAtual) {
                       retorno = false;
...
*/
           ...
           async calcEfic(tpMaq){
            ...
            eficPorTipoMaquina(tpMaq){
                ...
                if(tpMaq=='02'){   // cardas
                    ...
                    vT = 0;                     
                    if(this.producaoFiacao.rpm > 0 && this.tituloCarda> 0 )  {
                        vT =((this.producaoFiacao.rpm * 60 * 0.59)/this.tituloCarda ) /1000;   // producao hora  
                        this.prodKgh = ((this.producaoFiacao.rpm * 60 * 0.59)/this.tituloCarda) /1000; 
                ...
                .then(response => {        
                    ...
                    if (this.resultado.codigo != null && this.resultado.codigo != ''){
                        ...
                        if (this.resultado.titulo != null && this.resultado.titulo != ''){
                            ...
                            this.tituloCarda=this.resultado.titulo;
                        } else{
                            if(this.cdTipoMaquina=='02'){
                                this.producaoFiacao.tituloCadastro=0;
                                this.producaoFiacao.tituloReal=0
                            ...
                            //if(await this.validaDatas()){
                                   ...
                                   let url = `${process.env.VUE_APP_BASE_URL}/producao`  ;
                                    ...
                                    {                                
                                        ...
                                        "loteProducao"	       : this.producaoFiacao.loteProducao,	 
                                        ...
                                        "numeroRupturas"       : this.producaoFiacao.numeroRupturas    ,
                                        "metragem"	           : this.producaoFiacao.metragem	       ,
                                        "idSSM"		           : this.producaoFiacao.idSSM	       ,
                                        ...
                                        "operador"	           : this.producaoFiacao.operador	,
                                                ...
                                                if (this.tipoOperacao == 'A'   ) { 
                                                    await this.axios.put(
                                                        ...
                                                        .then(response => { 
                                                            ...
                                                            //this.haSucesso = true 
                                                            //this.mensagemSucesso = 'Produção atualizada com sucesso.'  
                                                            //this.mensagemSucesso = response.data 
                                                            this.apiDisplayMensagemSucesso(response.data  )
            ...
            async buscaByChave(){  
                ...
                if(this.validaChave()){          
                    ...
                    this.mensagemErro = ''; 
                    this.haErros = false ;
                    //console.log('buscaByChave 1111 aaaaa');  
                    if(await this.validaDatasPopUp()) {        
                          //console.log('buscaByChave 1111 bbbbbb');             
    
                          const resposta = await this.populaForm();      


                          //console.log('buscaByChave resposts');    
            ...
            async validaDatasPopUp(){                
                ...
                if (this.tipoOperacao=="I") {        
                        ...
                        .catch(error => { 
                            ...
                            //console.log("Erro:xxxxxxxxxxx ZZZZ", error.response.data.message);
                            this.haErros = true
                            this.mensagemErro = error.response.data.message
            ...
            async validaDatas(){                
                ...
                if (this.tipoOperacao=="I") {          
                        ...
                        .catch(error => {
                            ...
                            this.resetForm = true;
                            this.resetarForm();    
                            //console.log("Erro: ZZZZ", error.response.data.message);
                            this.haErros = true
                            this.mensagemErro = error.response.data.message
            ...
            async populaForm(){ 
                ...
                .then(response => {        
                   ...
                   //console.log(this.resultado  );
                    ...
                    if (this.resultado.numeroRupturas != null){
                        this.producaoFiacao.numeroRupturas = this.resultado.numeroRupturas;  
                    
                    }else{
                        this.producaoFiacao.numeroRupturas        = 0 ;                       
                    }   
                   ...
                   //     this.producaoFiacao.localFisico = this.resultado.localFisico;  
                    //    this.localFisico  = this.resultado.localFisico;  
                    
                    //}else{
                    ////    this.producaoFiacao.localFisico        = '';        
                        //this.localFisico  = 'kk1';               
                    //}  
        ...
        mounted(){
            ...
            if(this.tipoMaquinaProps=='02'){
                ...
                this.nmTpMaq = " - Open End"
            }else if(this.tipoMaquinaProps=='06'){
                this.nmTpMaq = " - Conicaleiras"
            }
        ...
        watch: {
            ...
            localFisico(newValue,oldValue) {
                ...
                if(newValue!=oldValue){
                    ...
                    if(this.localFisico.length!=null && this.localFisico.length!="" &&
                    this.cdTipoMaquina.length!=null && this.cdTipoMaquina.length!=""){
