<template>
  <!-- Modal Pesquisa item-->
  <div class="modal fade" id="modalPesquisaItem" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabelitem" aria-hidden="true">
              ...
              <thead>
                ...
                <tbody class="detalhePesquisa">
                    ...
                    <tr v-for="c in apiDisplayedDados" :key="c">
                        ...
                        <td class="text-start">{{ c.material.descricao}}</td>
                    </tr>
                    </template>
                </tbody>
            </table>
...
<script>
    ...
    $('#modalPesquisaItem').on('shown', function () {
        alert("aqui");
    })
